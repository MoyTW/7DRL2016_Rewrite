...
class EventParam(Enum):
    (QUANTITY, DAMAGE_TYPE, HANDLER, X, Y, PLAYER, FOV_MAP, TARGET, LEVEL, SOURCE, INPUT_COMMAND, KILLER, MOUNT, ITEM,
     FACTION, COMPONENTS, DROPS_THROUGH, TAKES_TURN_IMMEDIATELY) = range(18)
